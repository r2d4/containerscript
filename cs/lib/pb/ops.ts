...
/**
 * OpMetadata is a per-vertex metadata entry, which can be defined for arbitrary
 * Op vertex and overridable on the run time.
 */
export interface OpMetadata {
  /** ignore_cache specifies to ignore the cache for this Op. */
  ignoreCache: boolean;
  /**
   * Description can be used for keeping any text fields that builder doesn't
   * parse
   */
...
export interface Definition {
   ...
   * A key must be an LLB op digest string. Currently, empty string is not
   * expected as a key, but it may change in the future.
   */
  metadata: { [key: string]: OpMetadata };
  /**
   * Source contains the source mapping information for the vertexes in the
   * definition
   */
  Source?: Source;
}
...
export interface FileAction {
  ...
  copy?: FileActionCopy | undefined;
  /** FileActionMkFile creates a new file */
  mkfile?: FileActionMkFile | undefined;
  /** FileActionMkDir creates a new directory */
  mkdir?: FileActionMkDir | undefined;
...
export interface FileActionCopy {
  ...
  /**
   * attemptUnpackDockerCompatibility detects if src is an archive to unpack it
   * instead
   */
  ...
  /**
   * allowEmptyWildcard doesn't fail the whole copy if wildcard doesn't resolve
   * to files
   */
  ...
  /**
   * exclude files/dir matching any of these patterns (even if they match an
   * include pattern)
   */
...
export const Op = {
  ...
  fromJSON(object: any): Op {
    return {
      ...
      source: isSet(object.source)
        ? SourceOp.fromJSON(object.source)
        : undefined,
  ...
  toJSON(message: Op): unknown {
    ...
    message.exec !== undefined &&
      (obj.exec = message.exec ? ExecOp.toJSON(message.exec) : undefined);
    message.source !== undefined &&
      (obj.source = message.source
        ? SourceOp.toJSON(message.source)
        : undefined);
    message.file !== undefined &&
      (obj.file = message.file ? FileOp.toJSON(message.file) : undefined);
    message.build !== undefined &&
      (obj.build = message.build ? BuildOp.toJSON(message.build) : undefined);
    message.merge !== undefined &&
      (obj.merge = message.merge ? MergeOp.toJSON(message.merge) : undefined);
    message.diff !== undefined &&
      (obj.diff = message.diff ? DiffOp.toJSON(message.diff) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Op>, I>>(object: I): Op {
    ...
    message.exec =
      object.exec !== undefined && object.exec !== null
        ? ExecOp.fromPartial(object.exec)
        : undefined;
    message.source =
    ...
    message.file =
      object.file !== undefined && object.file !== null
        ? FileOp.fromPartial(object.file)
        : undefined;
    message.build =
    ...
    message.diff =
      object.diff !== undefined && object.diff !== null
        ? DiffOp.fromPartial(object.diff)
        : undefined;
    message.platform =
...
export const Platform = {
  ...
  fromJSON(object: any): Platform {
    return {
      ...
      OSFeatures: Array.isArray(object?.OSFeatures)
        ? object.OSFeatures.map((e: any) => String(e))
        : [],
    };
  },
...
export const ExecOp = {
  ...
  fromJSON(object: any): ExecOp {
    return {
      ...
      security: isSet(object.security)
        ...
        : 0,
      secretenv: Array.isArray(object?.secretenv)
  ...
  toJSON(message: ExecOp): unknown {
    ...
    if (message.secretenv) {
      obj.secretenv = message.secretenv.map((e) =>
        e ? SecretEnv.toJSON(e) : undefined
      );
    } else {
      obj.secretenv = [];
    }
...
export const Meta = {
  ...
  fromJSON(object: any): Meta {
    return {
      ...
      ulimit: Array.isArray(object?.ulimit)
  ...
  toJSON(message: Meta): unknown {
    ...
    message.proxyEnv !== undefined &&
      (obj.proxyEnv = message.proxyEnv
        ? ProxyEnv.toJSON(message.proxyEnv)
        : undefined);
    ...
    if (message.ulimit) {
      obj.ulimit = message.ulimit.map((e) =>
        e ? Ulimit.toJSON(e) : undefined
      );
    } else {
      obj.ulimit = [];
    }
  ...
  toJSON(message: Mount): unknown {
    ...
    message.TmpfsOpt !== undefined &&
      (obj.TmpfsOpt = message.TmpfsOpt
        ? TmpfsOpt.toJSON(message.TmpfsOpt)
        : undefined);
    message.cacheOpt !== undefined &&
      (obj.cacheOpt = message.cacheOpt
        ? CacheOpt.toJSON(message.cacheOpt)
        : undefined);
    message.secretOpt !== undefined &&
      (obj.secretOpt = message.secretOpt
        ? SecretOpt.toJSON(message.secretOpt)
        : undefined);
    message.SSHOpt !== undefined &&
      (obj.SSHOpt = message.SSHOpt ? SSHOpt.toJSON(message.SSHOpt) : undefined);
  ...
  toJSON(message: BuildOp_InputsEntry): unknown {
    ...
    message.value !== undefined &&
      (obj.value = message.value
        ? BuildInput.toJSON(message.value)
        : undefined);
    return obj;
  },
  ...
  toJSON(message: OpMetadata): unknown {
    ...
    message.exportCache !== undefined &&
      (obj.exportCache = message.exportCache
        ? ExportCache.toJSON(message.exportCache)
        : undefined);
    obj.caps = {};
    if (message.caps) {
...
export const Source_LocationsEntry = {
  ...
  toJSON(message: Source_LocationsEntry): unknown {
    ...
    message.key !== undefined && (obj.key = message.key);
    message.value !== undefined &&
      (obj.value = message.value ? Locations.toJSON(message.value) : undefined);
    return obj;
  },
...
export const Range = {
  ...
  toJSON(message: Range): unknown {
    ...
    message.start !== undefined &&
      (obj.start = message.start ? Position.toJSON(message.start) : undefined);
    message.end !== undefined &&
      (obj.end = message.end ? Position.toJSON(message.end) : undefined);
    return obj;
  },
...
export const Definition = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Definition {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.def.push(reader.bytes() as Buffer);
          break;
        case 2:
  ...
  fromJSON(object: any): Definition {
    return {
      def: Array.isArray(object?.def)
        ? object.def.map((e: any) => Buffer.from(bytesFromBase64(e)))
        : [],
...
export const Definition_MetadataEntry = {
  ...
  toJSON(message: Definition_MetadataEntry): unknown {
    ...
    message.value !== undefined &&
      (obj.value = message.value
        ? OpMetadata.toJSON(message.value)
        : undefined);
    return obj;
  },
  ...
  toJSON(message: FileOp): unknown {
    ...
    if (message.actions) {
      obj.actions = message.actions.map((e) =>
        e ? FileAction.toJSON(e) : undefined
      );
    } else {
      obj.actions = [];
    }
  ...
  fromJSON(object: any): FileAction {
    return {
      ...
      copy: isSet(object.copy)
        ? FileActionCopy.fromJSON(object.copy)
        : undefined,
      mkfile: isSet(object.mkfile)
        ? FileActionMkFile.fromJSON(object.mkfile)
        : undefined,
      mkdir: isSet(object.mkdir)
        ? FileActionMkDir.fromJSON(object.mkdir)
        : undefined,
  ...
  toJSON(message: FileAction): unknown {
    ...
    message.copy !== undefined &&
      (obj.copy = message.copy
        ? FileActionCopy.toJSON(message.copy)
        : undefined);
    message.mkfile !== undefined &&
      (obj.mkfile = message.mkfile
        ? FileActionMkFile.toJSON(message.mkfile)
        : undefined);
    message.mkdir !== undefined &&
      (obj.mkdir = message.mkdir
        ? FileActionMkDir.toJSON(message.mkdir)
        : undefined);
    message.rm !== undefined &&
      (obj.rm = message.rm ? FileActionRm.toJSON(message.rm) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FileAction>, I>>(
    ...
    message.rm =
      object.rm !== undefined && object.rm !== null
        ? FileActionRm.fromPartial(object.rm)
        : undefined;
    return message;
  },
};
...
export const FileActionCopy = {
  ...
  fromJSON(object: any): FileActionCopy {
    return {
      ...
      includePatterns: Array.isArray(object?.includePatterns)
        ? object.includePatterns.map((e: any) => String(e))
        : [],
      excludePatterns: Array.isArray(object?.excludePatterns)
        ? object.excludePatterns.map((e: any) => String(e))
        : [],
    };
  },
  ...
  toJSON(message: FileActionCopy): unknown {
    ...
    message.owner !== undefined &&
      (obj.owner = message.owner ? ChownOpt.toJSON(message.owner) : undefined);
    message.mode !== undefined && (obj.mode = Math.round(message.mode));
...
export const ChownOpt = {
  ...
  toJSON(message: ChownOpt): unknown {
    ...
    message.user !== undefined &&
      (obj.user = message.user ? UserOpt.toJSON(message.user) : undefined);
    message.group !== undefined &&
      (obj.group = message.group ? UserOpt.toJSON(message.group) : undefined);
    return obj;
  },
  ...
  fromJSON(object: any): UserOpt {
    return {
      byName: isSet(object.byName)
        ? NamedUserOpt.fromJSON(object.byName)
        : undefined,
  ...
  toJSON(message: UserOpt): unknown {
    ...
    message.byName !== undefined &&
      (obj.byName = message.byName
        ? NamedUserOpt.toJSON(message.byName)
        : undefined);
  ...
  toJSON(message: MergeOp): unknown {
    ...
    if (message.inputs) {
      obj.inputs = message.inputs.map((e) =>
        e ? MergeInput.toJSON(e) : undefined
      );
    } else {
      obj.inputs = [];
    }
  ...
  toJSON(message: DiffOp): unknown {
    ...
    message.lower !== undefined &&
      (obj.lower = message.lower
        ? LowerDiffInput.toJSON(message.lower)
        : undefined);
    message.upper !== undefined &&
      (obj.upper = message.upper
        ? UpperDiffInput.toJSON(message.upper)
        : undefined);
    return obj;
  },
